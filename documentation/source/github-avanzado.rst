...
.. __clonar_un_repositorio:

Clonar un repositorio
---------------------

Nos vamos a la web del proyecto en el que queremos colaborar. Pulsamos
en el botón de fork y eso creará una copia en nuestro perfil.
...
-  En la parte derecha un selector para cambiar de contexto entre:
   explorador de código, peticiones de colaboración (pull request),
   wiki, configuración, etc.
...
añadiremos a la orden ``git clone`` como en la primera línea del
siguiente grupo de órdenes:
...
.. __sincronizar_con_el_repositorio_original:
...
remota llamada *origin* que apunta al repositorio de donde clonamos el
...
original se llama *upstream* y se crea de la siguiente manera:
...
Recordemos que *fetch* solo trae los cambios que existan en el
repositorio remoto sin hacer ningún cambio en nuestro repositorio. Es la
orden *merge* la que se encarga de que todo esté sincronizado. En este
caso decimos que queremos fusionar con la rama *master* que está en el
repositorio *upstream*.

.. __creando_nuevas_funcionalidades:
...
integraremos en la rama *master* de nuestro repositorio y enviamos los
cambios a Github:
...
Pulsamos y entramos en la petición de *Pull Request*. Este es el momento
...
pulsamos *Send pull request* y le llegará nuestra petición al dueño del
proyecto.

|Gestión de un \_Pull Request\_|
...
proyecto le llegará el *Pull Request* y la lista de cambios. Ahora en
...
|Conversación en un \_PullRequest\_|
...
*add-license*? Pues porque usualmente el administrador puede haber
...
.. __todo_esto_es_algo_complicado:
...
.. important::
   ...
   No avanzar al siguiente nivel de complejidad, hasta no haber
   entendido completamente el anterior.
...
`StackOverflow <http://stackoverflow.com/>`__. Es una web de preguntas y
...
lenguaje de marcado de texto denominado *Markdown*. En la siguiente web
...
-  `Plantilla
   básica <https://gist.github.com/PurpleBooth/109311bb0361f32d87a2>`__

-  `Plantilla
   avanzada <https://github.com/othneildrew/Best-README-Template>`__

.. __documentación_del_curso:

Documentación del curso
~~~~~~~~~~~~~~~~~~~~~~~

Esta documentación está hecha en Asciidoc y pasada a PDF gracias a la
herramienta `Asciidoctor <https://docs.asciidoctor.org>`__.

El material está publicado con licencia `Atribución-NoComercial 4.0
Internacional (CC BY-NC
4.0) <https://creativecommons.org/licenses/by-nc/4.0/deed.es>`__

.. |Barra de información de proyecto| image:: github-proyect.png
.. |Espacio de trabajo| image:: github-main.png
.. |Aviso de nueva rama| image:: github-pushed.png
.. |Creando un Pull Request| image:: github-mergerequest.png
.. |Gestión de un \_Pull Request\_| image:: github-pullrequest.png
.. |Conversación en un \_PullRequest\_| image:: github-pullconversation.png
